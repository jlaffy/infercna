...
The infercna package makes these steps fast and easy:
...
This document introduces you to infercna's basic set of tools, and shows you how to apply them to data frames. infercna also supports databases via the dbplyr package, once you've installed, read `vignette("dbplyr")` to learn more.
