...
fetchModes = function(m, prob = 0.95, coverage = 0.8, size = 10, by = 'chr') {
...
expandToClones = function(modes, greaterThan = NULL) {
    modes = sapply(modes, function(x) {
                       stats::setNames(unlist(x), rep(names(x), lengths(x)))}, simplify = F)
    modes = unlist(modes)
...
findClones = function(m, prob = 0.95, coverage = 0.8, mode.size = 10, clone.size = NULL, by = 'chr') {
    modes = fetchModes(m, prob = prob, coverage = coverage, size = mode.size, by = by)
